...
Downstream read order: `.planning/SPEC.md`, then the relevant `specs/*.md`, then the root-package implementation projections (`README.md`, `docs/WORKFLOW.md`, `scripts/`, `config/`, `hermes/`, `skills/`, `claude-config/`).
...
|---|---|---|
| `specs/file-bus.md` | File-bus protocol, envelope, ownership, locking, validation, and audit migration projection. | `scripts/bin/orch-bus-loop`, `scripts/tests/test-file-bus.sh`, `README.md`, `docs/WORKFLOW.md` |
