...
- [ ] 阻塞校验引擎与原子写入器作为独立 helper modules
- [ ] 原子写使用 write-to-temp + fsync + rename 模式

## 文档交付物
- [ ] `docs/FULL-CAPABILITY-AUTHORITY-MATRIX.md` 更新：六分类信息保留要求
- [ ] `docs/prd_by_kimi.md` 更新：补全包结构定义章节
- [ ] `docs/user-flow-guide_by_kimi.md` 更新：0 阶补全流程 + 阻塞校验行为
- [ ] `docs/CONFIGURATION.md` 更新：原子写配置与恢复流程

## 任务完成状态
- [ ] U2a — 六分类 Schema & 结构化补全包
- [ ] U2b — 阻塞校验引擎 & 文件态原子持久化
