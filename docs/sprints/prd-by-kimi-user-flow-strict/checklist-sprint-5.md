...
- [x] 安全扫描器作为独立 helper module（可被 S4b 复用）
- [x] alias-mapping.json 通过 JSON Schema 校验且版本受控

## 文档交付物
- [x] `docs/adr/0001-full-debate-package-team-registry.md` 更新：安全红线清单 + 别名映射 schema
- [x] `docs/adr/0009-dynamic-debate-assembly-policy.md` 更新：maxItems 动态配置决策
- [x] `docs/CONFIGURATION.md` 更新：`max_teams` 配置 + 安全红线关键词列表
- [x] `docs/user-flow-guide_by_kimi.md` 更新：1 阶方向辩论流程

## 任务完成状态
- [x] U5a — 辩论工单契约与团队策略引擎
- [x] U5b — 安全红线、别名映射与 Schema 扩展
