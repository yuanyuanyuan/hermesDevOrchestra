...
- [x] 通道分级器、Rollout Gate、证据检测引擎、安全门控均为独立 helper modules
- [x] auto_merge 目标分支必须通过配置白名单校验，禁止硬编码

## 文档交付物
- [x] `docs/CONFIGURATION.md` 更新：三层通道配置、Rollout Gate 参数、auto_merge 分支保护
- [x] `docs/user-flow-guide_by_kimi.md` 更新：1 阶通道分级 + Light 通道职责 + auto_merge 安全流程
- [x] `docs/sandbox-simulation-report.md` 更新：Quick→Light→Standard 渐进场景模拟

## 任务完成状态
- [x] U4a — 三层通道路由与 Rollout Gate
- [x] U4b — auto_merge 安全控制与证据检测引擎
