...
- [ ] Override 日志写入使用 `atomic_writer.py`（S2b 产物）
- [ ] 配置加载器作为独立 helper module

## 文档交付物
- [ ] `docs/CONFIGURATION.md` 更新：`interaction.default_mode` 与 `--interactive` / `--batch` 标志
- [ ] `docs/user-flow-guide_by_kimi.md` 更新：摘要/详细模式 + CLI 交互与非交互差异
- [ ] `docs/sandbox-simulation-report.md` 更新：两轮纠错 CLI 行为模拟

## 任务完成状态
- [ ] U3a — 摘要/详细模式与 project-profile 配置统一
- [ ] U3b — 两轮纠错门控与 CLI 适配
