...
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-decisions" test-proj > /tmp/orch-decision-cli-list.out
...
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-approve" "$id_approve" "APPROVED fixture" >/tmp/orch-decision-cli-approve.out
assert_contains "APPROVED $id_approve" /tmp/orch-decision-cli-approve.out "approval output missing"
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-reject" "$id_reject" "REJECTED fixture" >/tmp/orch-decision-cli-reject.out
