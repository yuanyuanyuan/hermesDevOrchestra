...
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-init" alpha "$ALPHA_DIR" >/tmp/orch-project-isolation-alpha-init.out
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-init" beta "$BETA_DIR" >/tmp/orch-project-isolation-beta-init.out
...
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-profile-sync" alpha "$ALPHA_DIR" >/tmp/orch-project-isolation-alpha-sync.out
"$REPO_ROOT/docs/orchestra/scripts/bin/orch-profile-sync" beta "$BETA_DIR" >/tmp/orch-project-isolation-beta-sync.out
