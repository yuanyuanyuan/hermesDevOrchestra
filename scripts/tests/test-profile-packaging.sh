...
"$REPO_ROOT/scripts/bin/orch-init" test-proj "$PROJECT_DIR" >/tmp/orch-profile-packaging-init.out
...
"$REPO_ROOT/scripts/bin/orch-profile-sync" test-proj "$PROJECT_DIR" >/tmp/orch-profile-packaging-sync.out
