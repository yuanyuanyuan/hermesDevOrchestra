...
assert_contains "~/.local/share/hermes-orchestra/{project}/audit.jsonl" "$REPO_ROOT/docs/orchestra/README.md" "README must document Audit JSONL path"
assert_contains "docs/COVERAGE-MATRIX.md" "$REPO_ROOT/docs/orchestra/README.md" "README must reference docs/COVERAGE-MATRIX.md"
