...
assert_contains "orch-decisions" "$REPO_ROOT/README.md" "README must document orch-decisions"
assert_contains "orch-approve" "$REPO_ROOT/README.md" "README must document orch-approve"
assert_contains "orch-reject" "$REPO_ROOT/README.md" "README must document orch-reject"
assert_contains "orch-risk-check" "$REPO_ROOT/README.md" "README must document orch-risk-check"
assert_contains "orch-audit" "$REPO_ROOT/README.md" "README must document orch-audit"
assert_contains "orch-verify" "$REPO_ROOT/README.md" "README must document orch-verify"
assert_contains "~/.local/share/hermes-orchestra/{project}/audit.jsonl" "$REPO_ROOT/README.md" "README must document Audit JSONL path"
assert_contains "docs/COVERAGE-MATRIX.md" "$REPO_ROOT/README.md" "README must reference docs/COVERAGE-MATRIX.md"
