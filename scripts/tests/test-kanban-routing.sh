...
JSON
"$REPO_ROOT/scripts/bin/orch-bus-loop" route-research "$PROJECT_DIR" --once
...
JSON
"$REPO_ROOT/scripts/bin/orch-bus-loop" route-skeleton "$PROJECT_DIR" --once
...
JSON
"$REPO_ROOT/scripts/bin/orch-bus-loop" route-resume "$PROJECT_DIR" --once
