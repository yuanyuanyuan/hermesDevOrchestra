...
"$REPO_ROOT/scripts/bin/orch-init" test-proj "$PROJECT_DIR" >/tmp/orch-init-start-init.out
"$REPO_ROOT/scripts/bin/orch-start" test-proj "$PROJECT_DIR" >/tmp/orch-init-start-start.out
"$REPO_ROOT/scripts/bin/orch-status" test-proj > /tmp/orch-init-start-status.out
"$REPO_ROOT/scripts/bin/orch-stop" test-proj >/tmp/orch-init-start-stop.out || true
