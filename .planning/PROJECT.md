...
(None — v1 specification package requirements are validated.)
...
v1.0 is shipped as a complete specification package. The canonical v1 deliverable is `.planning/SPEC.md`; milestone archives live under `.planning/milestones/`; execution artifacts are archived under `.planning/milestones/v1.0-phases/`.

## Next Milestone Goals

- Start a new milestone with `$gsd-new-milestone` before adding implementation work.
- Convert the v1 contracts into implementation phases only after fresh requirements are defined.
- Revalidate Claude Code CLI, Codex CLI, Hermes Agent, and remote adapter assumptions before implementation.
