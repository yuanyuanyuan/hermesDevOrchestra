...
Hermes Dev Orchestra v1.0 ships the specification package for a single-developer, multi-project AI development orchestration system. The milestone defines scope, authority, runtime assumptions, command contracts, file-bus protocol, scheduling/isolation rules, agent collaboration, risk gates, remote decision abstraction, recovery, observability, acceptance scenarios, and implementation handoff.

## Phase Archive

Phase execution artifacts are archived under `.planning/milestones/v1.0-phases/`.
...
- [x] **Phase 1: Scope, Package Coverage & Authority** - Locks v1 boundaries, inline spec coverage, and actor approval authority. (completed 2026-04-25)
- [x] **Phase 2: Runtime, Installation & Command Contracts** - Defines safe no-sudo host assumptions, invocation profiles, paths, and CLI command contracts. (completed 2026-04-25)
- [x] **Phase 3: File Bus, Decision Envelope, State & Audit** - Freezes the canonical JSON/JSONL protocol, state machine, and durable evidence model. (completed 2026-04-25)
- [x] **Phase 4: Multi-Project Scheduling & Isolation** - Specifies append-anytime routing across isolated projects with blocked-project yielding. (completed 2026-04-25)
- [x] **Phase 5: Agent Protocol, Challenge & Evidence** - Defines Hermes, Claude, and Codex collaboration rules plus verifiable completion evidence. (completed 2026-04-25)
- [x] **Phase 6: Risk Rulebook & Remote Decision Contract** - Specifies risk gates, static rule enforcement, Remote Decision Channel behavior, and local fallback. (completed 2026-04-25)
- [x] **Phase 7: Recovery, Observability, Verification & Handoff** - Completes status, recovery, acceptance scenarios, traceability, and implementation handoff. (completed 2026-04-25)
...
|-------|----------------|--------|-----------|
| 1. Scope, Package Coverage & Authority | 1/1 | Complete    | 2026-04-25 |
| 2. Runtime, Installation & Command Contracts | 1/1 | Complete    | 2026-04-25 |
| 3. File Bus, Decision Envelope, State & Audit | 1/1 | Complete    | 2026-04-25 |
| 4. Multi-Project Scheduling & Isolation | 1/1 | Complete    | 2026-04-25 |
| 5. Agent Protocol, Challenge & Evidence | 1/1 | Complete    | 2026-04-25 |
| 6. Risk Rulebook & Remote Decision Contract | 1/1 | Complete    | 2026-04-25 |
| 7. Recovery, Observability, Verification & Handoff | 1/1 | Complete    | 2026-04-25 |
